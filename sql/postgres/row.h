...
namespace sql::postgres
{
    ...
    private:
        template <typename T>
        static T flipByteOrder(const T v)
        {
        ...
        template <typename T>
        static SqlVariant parseInt(const char* binary_value)
        {
            T int_value;
        ...
        template <typename T>
        static SqlVariant parseFloat(const char* binary_value)
        {
        ...
        static SqlVariant parseDecimal(const char* binary_value, const int value_length)
        {
            if (value_length < 8) {
