...
REGISTER_GENERATOR("tpch.supplier", resource::supplier_sql, supplier_download, TPCH_SF * 10000);
REGISTER_GENERATOR("tpch.part", resource::part_sql, part_download, TPCH_SF * 200000);
